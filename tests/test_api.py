...
def patch_services(monkeypatch):
    ...
    # Patch the actual imports used by FastAPI app
    monkeypatch.setattr("app.services.storage_service.StorageService", mock_storage_cls)
    monkeypatch.setattr("app.services.vector_service.VectorService", mock_vector_cls)
    monkeypatch.setattr("app.services.pdf_processor.PDFProcessor", mock_processor_cls)
